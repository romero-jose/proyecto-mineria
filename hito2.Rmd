...
En la pregunta siguiente se busca visualizar de mejor manera los destinos de las personas a medida que transcurre el día.

- ¿Donde se concentran los destinos de viaje según el lugar de origen y la hora?

Por un tema de curiosidad, se formula la siguiente pregunta:

- ¿Se puede predecir el propósito de los viajes con los datos que tenemos?
