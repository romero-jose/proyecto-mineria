...
(aux[order(aux, decreasing = TRUE)])[0:10]
```
Se encuentran gran cantidad de datos NA en 4 columnas. Teniendo en cuenta la cantidad total de datos en este dataset, las columnas "FactorFindesemanaEstival", "FactorDomingoNormal", "FactorSabadoNormal", "FactorLaboralEstival" y "ActividadDestino" se eliminaran
...
Boxplot para matriz 2019.08, utilizando hora y viaje promedio:
