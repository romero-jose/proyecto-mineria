...
loc2 <- locale("en", decimal_mark = '.', encoding='latin1')
...
viajeslaboral_2020 <- read_csv2('datos/viajes2020_03_laboral_100k.csv', locale = loc2, na = c('-', 'NA'), guess_max = 10000)
...
viajeslaboral_2020 %>%
  ...
  ggplot(aes(x=tviaje_seg/60.)) +
  geom_histogram(binwidth = 10) +
  labs(x='Tiempo de viaje [min]', title = 'Distribución del tiempo de viaje', y="Frecuencia")
```
```{r}
viajeslaboral_2020 %>%
  filter(!is.na(tviaje_seg)) %>%
